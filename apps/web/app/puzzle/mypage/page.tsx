...
import { AchievementBadges } from '@/components/puzzle/achievement-badges';
    ...
    <div className={`${styles.container} puzzle-animate-fade-in-up`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <AchievementBadges statistics={statistics} completedHistoryLength={completedHistory.length} />
