...
import { CreatorView, ClosedView, SubmittedView, LoadingView } from './friend-answer-views';
...
export default function FriendAnswerPage({ shareId }: FriendAnswerPageProps) {
    ...
    if (isCreator) return <CreatorView shareId={shareId} />;
    if (isClosed) return <ClosedView shareId={shareId} />;
    if (submitted) return <SubmittedView shareId={shareId} />;
